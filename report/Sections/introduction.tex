...
This work makes three contributions. First, it provides a detailed empirical analysis of the severe technical constraints and data sparsity encountered when attempting to extract method-level dynamic dependencies from large-scale industrial projects. Second, it implements a GCN-style encoder combining static call graphs with CI metadata and demonstrates the limitations of a purely static approach in build failure prediction. Third, it analyzes the performance gap between static and dynamic features, offering insights into the necessity of dynamic analysis for robust CI integration in legacy LRTS environments.
